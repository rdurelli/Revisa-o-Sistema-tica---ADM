...
%\begin{figure*}[!h]
    %\subfloat[Frequency of studies in each category.\label{fig:bar}]{%
     % \includegraphics[width=0.45\textwidth]{figuras/barPlotModified}
    %}
    %\hfill
    %\subfloat[ADM standard metamodels used in the literature.\label{fig:pie}]{%
     % \includegraphics[width=0.35\textwidth]{figuras/pieChartModel}
    %}
  %\hfill
    %\subfloat[ADM standard metamodels used in the literature.\label{fig:pieEvaluation}]{%
     % \includegraphics[width=0.35\textwidth]{figuras/pieEvaluation}
    %}
