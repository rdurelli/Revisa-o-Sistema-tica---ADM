...
%\item \textbf{Method:} It refers to contributions which specifically describe methods that uses ADM and it's metamodels.

%\item \textbf{Technique:} It refers to contributions which specifically describe a technique to assist the modernization of legacy system by means of ADM and it's metamodels.
...
%\item \textbf{Framework:} It refers to contributions which specifically describe framework which uses ADM and it's metamodels.
...
The research type reflects the research approach used in the primary study. Therefore, we used and adapted the scheme proposed by Wieringa et al~\cite{Wieringa:2005:REP:1107677.1107683}. A brief description of research types are as follows:
\begin{itemize}
